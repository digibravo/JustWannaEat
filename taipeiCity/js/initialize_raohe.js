...
function menuClick(){
	var position = $('#table_raoheMarket').position().left;
	if(position > 0)
	{
		$('#table_raoheMarket').animate({left:"0px"});
	}
	else
	{
		$('#table_raoheMarket').animate({left:"327px"});
	}
}

function listMenuClick(){
	var position = $('#table_raoheMarket_list').position().left;
	if(position > 0)
	{
		$('#table_raoheMarket_list').animate({left:"0px"});
	}
	else
	{
		$('#table_raoheMarket_list').animate({left:"327px"});
	}
}
...
function initList()
{
	...
	for (var i = 0; i < raoheShops.length; i++) 
	{
		...
		marker.myimgLink =place.imglink;
